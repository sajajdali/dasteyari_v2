...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | نام فارسی فیلدها — برای جایگزینی :attribute در پیام‌های بالا
    |--------------------------------------------------------------------------
    | هر فیلد جدیدی که در فرم‌های پروژه (Livewire) اضافه می‌شود، اینجا هم اضافه شود.
    */
    'attributes' => [
        'identity' => 'شماره موبایل یا ایمیل',
        'email' => 'ایمیل',
        'password' => 'گذرواژه',
